...
class CreateTaskForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'title': forms.TextInput(attrs={'class': 'input_field inp', 'placeholder': 'ведіть назву завдання...'}),
...
class ProfileEditForm(forms.ModelForm):
    ...
    # Check name and last name for the presence of prohibited characters or numbers
